...
نتایج این پروژه نشان داد که قیمت بیت‌کوین غیرمانا و بازدهی‌های آن مانا هستند. 
 مدل ARIMA ---------(توان محدودی در پیش‌بینی بازدهی آینده داشت)
 مدل GARCH ---------(توانست رفتار نوسانات بازار را به خوبی مدل‌سازی کند)
 مقدار α + β= 0.973 ---------(بیانگر پایداری بسیار بالای نوسانات و وجود پدیده خوشه‌بندی نوسانات است) 
